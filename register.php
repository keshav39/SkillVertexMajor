                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-10 col-lg-6 col-xl-5
                                        ...
                                        <form class="mx-1 mx-md-4">
                                            ...
                                            <div class="mb-3">
                                                <p>Alreay have an account? <a href="login.php">Login</a></p>
                                            </div>
                                        </form>
                                    ...
                                    <div class="col-md-10 col-lg-6 col-xl-7
                                        ...
                                        <img
                                            ...
                                            class="img-fluid mb-10" style="object-fit: cover; width: 500px; border-radius: 10px; opacity: 0.9;" alt="Sample
                                            image">
         ...
         <footer class="bg-light text-center text-lg-start">          
            ...
            <div class="text-center p-2" id="Footer">
             <p class="mt-3"> © 2020 Copyright:
              <a class="text-dark fw-bold" href="#">Super-Market</a></p>
            </div>
            <!-- Copyright -->
          </footer>
        <!-- Footer End -->
